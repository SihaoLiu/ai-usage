...
fn sequenced_remote_record(
    ...
    SequencedWireRecord {
        ...
        record: WireRecord {
            ...
            cache_creation_5m_input_tokens: record.entry.usage.cache_creation_5m_input_tokens,
            cache_creation_1h_input_tokens: record.entry.usage.cache_creation_1h_input_tokens,
